...
public class LuosimaoDuanxinUtil {
    ...
    //短信平台的APIkey
    private static final String DUANXIN_API_KEY = "key-ac3d31417ee24a27aff9cfcb405386b2";//需要使用自己的APIkey
    private static final String SPEAK_API_KEY = "key-f5e4307ba49ff69867009875a2283d36";//需要使用自己的APIkey
